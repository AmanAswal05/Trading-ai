...
# We can use the same logic as prepare_model_matrix in the pipeline
...
# target for regression is actual_return
...
# Train a regressor walk-forward
...
print(f"Regression walk-forward median absolute error: {np.median(err) * 100:.4f}%")
